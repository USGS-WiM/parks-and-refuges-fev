...
var tidesMarkerIcon = L.icon({ className: 'tideMarker', iconUrl: 'images/markers/bluepushpin.png', iconAnchor: [7, 10], popupAnchor: [0, 2], iconSize: [8, 16] });
...
var tideCurrentSymbologyInterior = "<img class='legendSwatch' style='width: 10px' src='images/markers/bluepushpin.png'/><b>NOAA Tides and Currents<b>";
